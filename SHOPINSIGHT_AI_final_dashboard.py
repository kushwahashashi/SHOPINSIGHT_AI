...
with st.sidebar:
    st.markdown(
        ...
        <div style="text-align:center;padding:6px 0 18px 0;">
            <div style="font-size:22px;font-weight:800;">🛒 SHOPINSIGHT <span style="color:#c084fc;">AI</span></div>
            <div style="font-size:10px;color:#b8c8e8;margin-top:3px;">Smarter Insights. Bigger Sales.</div>
        </div>
        """,
        unsafe_allow_html=True
    )
...
with c2:
    if profile_path:
        st.image(str(profile_path), width=95)
    st.markdown(
        """
